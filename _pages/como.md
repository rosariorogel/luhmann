...
<img src="{{ site.baseurl }}/assets/img/Wakelet.png" style="float:left;width:200px;padding-right:20px;"> Para esta sección buscamos la manera de hacer que los conceptos de Luhmann fuesen más interactivos con los usuarios combinando la calidad y el realismo. Los videos generados por D-ID [**D-ID**](https://www.d-id.com/) son de alta calidad y parecen auténticos. La IA utiliza técnicas avanzadas de procesamiento de imágenes y aprendizaje profundo para garantizar que los resultados sean visualmente atractivos y realistas, y sobretodo que sean personalizados permitiendo que se acoplen a la estructura de la página web.
