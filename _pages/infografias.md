...
layout: page
title: Infografías
subtitle: Conceptos básicos de la teoría de sistemas sociales
permalink: infografias
---

# Infografías sobre conceptos luhmannianos

Esta sección reúne infografías elaboradas por estudiantes de Sociología de la Facultad de Ciencias Políticas y Sociales de la Universidad Autónoma del Estado de México como parte del proyecto **Luhmann en Web**, hoy actualizado como **Luhmann 5.0**.

Los materiales presentan, de manera sintética y visual, conceptos, trayectorias y sistemas funcionales asociados con la teoría de sistemas sociales de Niklas Luhmann. Su propósito es facilitar un primer acercamiento a una propuesta teórica compleja —de esas que no se dejan domesticar en dos párrafos, pero sí pueden empezar a entenderse con buenas mediaciones visuales.

Las infografías fueron elaboradas originalmente en [Canva](https://www.canva.com/) y publicadas por sus autoras en [Wikimedia Commons](https://commons.wikimedia.org/), como parte de una experiencia formativa orientada a la producción de recursos educativos abiertos, cultura digital y licenciamiento abierto.
...
Las infografías incluidas en esta página se enlazan desde Wikimedia Commons. Debido a la naturaleza abierta y colaborativa de esta plataforma, algunos archivos pueden ser modificados, trasladados o eliminados con el paso del tiempo.
...
<figure style="margin: 1.5rem 0;">
  <a href="https://commons.wikimedia.org/wiki/File:Biograf%C3%ADa_de_Niklas_Luhmann.png">
    <img
      src="https://commons.wikimedia.org/wiki/Special:Redirect/file/Biograf%C3%ADa_de_Niklas_Luhmann.png?width=500"
      alt="Biografía de Niklas Luhmann"
      style="max-width: 400px; width: 100%; height: auto;"
    />
  </a>

  <figcaption style="font-size:0.72em;color:#666;line-height:1.3;margin-top:6px;">
    <strong>Título:</strong> Biografía de Niklas Luhmann.
    <strong>Autoría:</strong> Aranza Cura-Lara.
    <strong>Fuente:</strong>
    <a href="https://commons.wikimedia.org/wiki/File:Biograf%C3%ADa_de_Niklas_Luhmann.png">Wikimedia Commons</a>.
...
<figure style="margin: 1.5rem 0;">
  <a href="https://commons.wikimedia.org/wiki/File:Contexto_hist%C3%B3rico_de_la_vida_de_Luhmann.png">
    <img
      src="https://commons.wikimedia.org/wiki/Special:Redirect/file/Contexto_hist%C3%B3rico_de_la_vida_de_Luhmann.png?width=500"
      alt="Contexto histórico de la vida de Luhmann"
      style="max-width: 400px; width: 100%; height: auto;"
    />
  </a>

  <figcaption style="font-size:0.72em;color:#666;line-height:1.3;margin-top:6px;">
    <strong>Título:</strong> Contexto histórico de la vida de Luhmann.
    <strong>Autoría:</strong> Jimena Dafne Garduño-Terrón.
    <strong>Fuente:</strong>
    <a href="https://commons.wikimedia.org/wiki/File:Contexto_hist%C3%B3rico_de_la_vida_de_Luhmann.png">Wikimedia Commons</a>.
    <strong>Licencia:</strong>
    <a href="https://creativecommons.org/licenses/by-sa/4.0/">CC BY-SA 4.0</a>.
  </figcaption>
</figure>
...
<figure style="margin: 1.5rem 0;">
  <a href="https://commons.wikimedia.org/wiki/File:Zettelkasten.png">
    <img
      src="https://commons.wikimedia.org/wiki/Special:Redirect/file/Zettelkasten.png?width=500"
      alt="Zettelkasten"
      style="max-width: 400px; width: 100%; height: auto;"
    />
  </a>
  ...
  <figcaption style="font-size:0.72em;color:#666;line-height:1.3;margin-top:6px;">
    <strong>Título:</strong> Zettelkasten.
    <strong>Autoría:</strong> Aranza Cura-Lara.
    <strong>Fuente:</strong>
    <a href="https://commons.wikimedia.org/wiki/File:Zettelkasten.png">Wikimedia Commons</a>.
    <strong>Licencia:</strong>
    <a href="https://creativecommons.org/licenses/by-sa/4.0/">CC BY-SA 4.0</a>.
  </figcaption>
</figure>
