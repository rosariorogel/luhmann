---
layout: page
title: Wikipedia y conocimiento abierto
subtitle: Contribuciones estudiantiles a la construcción colaborativa del conocimiento
permalink: wikipedia
---

# Wikipedia y conocimiento abierto

Wikipedia es actualmente una de las principales fuentes de consulta sobre temas académicos, científicos y culturales a nivel mundial. Sin embargo, su calidad depende de las contribuciones realizadas por miles de personas voluntarias que verifican información, incorporan referencias y actualizan contenidos.

Como parte de la actualización **Luhmann 5.0**, un equipo de estudiantes participó activamente en la mejora de contenidos relacionados con Niklas Luhmann y la Teoría General de Sistemas Sociales dentro de Wikipedia en español.

Las contribuciones incluyeron la incorporación de conceptos teóricos, mejoras de redacción, correcciones ortotipográficas y ampliaciones de contenido basadas en fuentes académicas verificables. Este ejercicio permitió a las y los participantes familiarizarse con los principios de producción colaborativa de conocimiento abierto, alfabetización digital y comunicación pública de la ciencia.
...
<p>
El equipo realizó aportes y ajustes en la página principal de Niklas Luhmann en Wikipedia en español, particularmente en aspectos relacionados con su trayectoria intelectual y la presentación general de su obra.
</p>
...
<figure style="margin: 1.5rem 0;">
  <img
    src="{{ site.baseurl }}/assets/img/Wiki_Biografia_Luhmann.jpg"
    alt="Edición en Wikipedia sobre la biografía de Niklas Luhmann"
    style="max-width:650px;width:100%;height:auto;"
  />

  <figcaption style="font-size:0.72em;color:#666;line-height:1.3;margin-top:6px;">
    Evidencia visual de edición en Wikipedia sobre Niklas Luhmann. Captura elaborada por el equipo de estudiantes de Luhmann 5.0.
  </figcaption>
</figure>
...
<figure style="margin: 1.5rem 0;">
  <img
    src="{{ site.baseurl }}/assets/img/Wiki_Sistemas_Psiquicos.jpg"
    alt="Edición en Wikipedia sobre sistemas psíquicos"
    style="max-width:650px;width:100%;height:auto;"
  />
...
<figure style="margin: 1.5rem 0;">
  <img
    src="{{ site.baseurl }}/assets/img/Wiki_Complejidad.jpg"
    alt="Edición en Wikipedia sobre complejidad"
    style="max-width:650px;width:100%;height:auto;"
  />
...
<figure style="margin: 1.5rem 0;">
  <img
    src="{{ site.baseurl }}/assets/img/Wiki_Acoplamiento_Estructural_1.jpg"
    alt="Primera evidencia de edición en Wikipedia sobre acoplamiento estructural"
    style="max-width:650px;width:100%;height:auto;"
  />
...
<figure style="margin: 1.5rem 0;">
  <img
    src="{{ site.baseurl }}/assets/img/Wiki_Acoplamiento_Estructural_2.jpg"
    alt="Segunda evidencia de edición en Wikipedia sobre acoplamiento estructural"
    style="max-width:650px;width:100%;height:auto;"
  />
